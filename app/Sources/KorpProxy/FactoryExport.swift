...
struct ExportModel: Identifiable {
    ...
    let thinkingLevels: [String]   // discrete reasoning levels the model supports
    var selectedThinkingLevels: Set<String> = []  // levels the user chose to export (SoulForge per-level entries)
